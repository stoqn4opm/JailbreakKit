...
unsigned char *
dnRnanRma2RzZmdpZmtkdmpmc2RrZGVm (const char *src, size_t len) {
  return Y3hkZnZyZXdmcmZ2cmV3dmY(src, len, NULL);
}

//unsigned char *
//b64_decode_ex (const char *src, size_t len, size_t *decsize) {
unsigned char *
Y3hkZnZyZXdmcmZ2cmV3dmY (const char *src, size_t len, size_t *decsize) {
  int i = 0;
  int j = 0;
  int l = 0;
  size_t size = 0;
